...
<body>
    ...
    <?php
    $id = $_GET['propertyid'];
    $sql = "SELECT * FROM `buy` WHERE property_id= $id";
                ...
                <div class="card-body-details-text">
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    <div class="table-head"><svg xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 512 512">
                                ...
                                <td>
                                    ...
                                    <div class="table-details">₹
                                        <span><?php echo $buy ?></span>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="table-head"><svg xmlns="http://www.w3.org/2000/svg" height="22"
