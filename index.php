...
<body>
    ...
    <section class="first-section background">
        <p>
            Welcome to <span class="color">S P PROPERTY</span>
        </p>
        <p>
            May Your Dream Home Become True
        </p>
        <div>
            Our Working Space
        ...
        <div class="search-div">
            <form action="search.php" class="search-form" method="get">
                <input type="search" name="query" placeholder="1BHK Rent/Buy" id="search">
    ...
    <section class="second-section">
        <h2>Buy - Flats</h2>
        <div class="container">
            <!-- Fetching the Data From thr Database -->
            <?php
                $sql = "SELECT * FROM `buy` WHERE BHK = '1BHK'";
                ...
                $sql = "SELECT * FROM `buy` WHERE BHK = '2BHK'";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    $id = $row['property_id'];
                    $img1 = $row['img1'];
                ...
                $sql = "SELECT * FROM `buy` WHERE BHK = '3BHK'";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    $id = $row['property_id'];
                    $img1 = $row['img1'];
                ...
                $sql = "SELECT * FROM `buy` WHERE BHK = '4BHK'";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    $id = $row['property_id'];
                    $img1 = $row['img1'];
        ...
        <div class="container">
            <!-- Fetching the Data From thr Database -->
            <?php
                $sql = "SELECT * FROM `rent`  WHERE BHK = '1BHK'";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    $id = $row['property_id'];
                    $img1 = $row['img1'];
                ...
                $sql = "SELECT * FROM `rent`  WHERE BHK = '2BHK'";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    $id = $row['property_id'];
                    $img1 = $row['img1'];
                ...
                $sql = "SELECT * FROM `rent`  WHERE BHK = '3BHK'";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    $id = $row['property_id'];
                    $img1 = $row['img1'];
                ...
                $sql = "SELECT * FROM `rent`  WHERE BHK = '4BHK'";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    $id = $row['property_id'];
                    $img1 = $row['img1'];
    ...
    var typed = new Typed('#element', {
        strings: ['Thakur Complex', 'Thakur Village', 'Kandivali East'],
        typeSpeed: 90,
        loop: true
    });
    </script>
