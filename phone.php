...
<head>
    ...
    <title>S P PROPERTY - Phone Number</title>
...
<body>
    ...
    <section class="phone-first-sec">
        <div class="back background-4">
            <div class="form-white-phone">
                <h2>Office Address & Phone Number</h2>
                <hr class="line">
                <div class="name">
                ...
                <div class="name">
                    ...
                    <p>Office Address:</p>
                    <span>Shop No: 19, Gokul Galaxy, Thakur Complex, Kandivali East, Mumbai-400101</span>
                </div>
                ...
                <div class="name">
                    ...
                    <p>Operating Area: </p>
                    <span>Thakur Copmlex, Thakur Village, Kandivali East.</span>
                </div>
                ...
                <div class="name">
                    ...
                    <p>Delling in:</p>
                    <span>Residential-Rental, Sell, Commercial Offices, Shop, Land & Ploat, Row House</span>
                </div>
