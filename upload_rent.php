...
<head>
    ...
    <title>listing of the Rent - Flat</title>
...
<body>
    ...
    <?php
        if (isset($_POST['submit'])) {
            ...
            $destinationfile1 = 'upload_rent/' . $filename1;
            $destinationfile2 = 'upload_rent/' . $filename2;
            $destinationfile3 = 'upload_rent/' . $filename3;
            $destinationfile4 = 'upload_rent/' . $filename4;
            $destinationfile5 = 'upload_rent/' . $filename5;
            $destinationfile6 = 'upload_rent/' . $filename6;
            $destinationfile7 = 'upload_rent/' . $filename7;
            $destinationfile8 = 'upload_rent/' . $filename8;
            $destinationfile9 = 'upload_rent/' . $filename9;
            ...
            $sql = "INSERT INTO `rent` (`img1`, `img2`, `img3`, `img4`, `img5`, `img6`, `img7`, `img8`, `img9`, `BHK`, `society_name`, `super_build`, `carpet`, `rent`, `parking`, `address`, `floor`, `facing`, `furnishing`, `property_age`, `date`, `water`, `Amenities`, `Description`) VALUES ('$destinationfile1','$destinationfile2','$destinationfile3','$destinationfile4','$destinationfile5','$destinationfile6','$destinationfile7','$destinationfile8','$destinationfile9', '$BHK', '$society_name', '$super_build', '$carpet', '$rent', '$parking', '$address', '$floor', '$facing', '$furnishing', '$property_age', '$date', '$water', '$Amenities', '$Description')";
        ...
        <div class="back background-2">
            <div class="form-white">
                <div class="signin-form">
                    <h1>Leasting of the Rental Flat</h1>
                    <hr class="line">
                    <form action="upload_rent.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="society_name" id="society_name" placeholder="Enter Society Name">
                        </div>

                        <div class="form-group">
                            <label for="super_build">Super Build up</label>
                            <input type="text" name="super_build" id="super_build" placeholder="Enter Super Build up">
                        </div>

                        <div class="form-group">
                            <label for="carpet">Carpet</label>
                            <input type="text" name="carpet" id="carpet" placeholder="Enter Carpet">
                        </div>

                        <div class="form-group">
                            <label for="rent">Rent</label>
                            <input type="text" name="rent" id="rent" placeholder="Enter Rent">
                        </div>

                        <div class="form-group">
                            <label for="parking">Parking</label>
                            <input type="text" name="parking" id="parking" placeholder="Enter Parking">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="facing" id="facing" placeholder="Enter Facing">
                        </div>

                        <div class="form-group">
                            <label for="furnishing">Furnishing</label>
                            <input type="text" name="furnishing" id="furnishing" placeholder="Enter Furnishing">
                        </div>

                        <div class="form-group">
                            <label for="property_age">Property Age</label>
                            <input type="text" name="property_age" id="property_age" placeholder="Enter Property Age">
                        </div>

                        <div class="form-group">
                            <label for="date">Property Posted Date</label>
                            <input type="date" name="date" id="date" placeholder="Enter Property Posted Date">
                        </div>

                        <div class="form-group">
                            <label for="water">Water Availability</label>
                            <input type="text" name="water" id="water" placeholder="Enter Water Availability">
                        </div>
